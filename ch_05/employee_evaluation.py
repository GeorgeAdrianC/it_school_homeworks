...
rating = float(input("Please type in a rating: "))
...
if rating < 0:
    ...
    multiplication_factor = rating
    performance = "meritorious"

raise_amount = multiplication_factor * 2400.00

print(f"The result is: {performance}")
print(f"The raise amount is: {raise_amount}")